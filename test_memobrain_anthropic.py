#!/usr/bin/env python3
"""
MemoBrain Test Script - Using Anthropic SDK with z.ai
"""
...
# Use haiku-equivalent for testing (faster)
...
async def test_basic_connection():
    ...
    print("\n" + "=" * 60)
    print("TEST 1: Basic API Connection (Anthropic SDK)")
    print("=" * 60)
    ...
    print(f"✓ MemoBrainAnthropic initialized")
...
async def test_init_memory(memory: MemoBrainAnthropic):
...
async def test_memorize(memory: MemoBrainAnthropic):
    """Test 3: Store reasoning episodes"""
    print("\n" + "=" * 60)
    print("TEST 3: Memorize Reasoning Episodes")
    print("=" * 60)

    # Simulate a reasoning episode
    episode1 = [
...
async def test_recall(memory: MemoBrainAnthropic):
...
async def test_persistence(memory: MemoBrainAnthropic):
    ...
    print(f"✓ Test snapshot saved for inspection")


async def main():
    print("\n" + "=" * 60)
    print("  MemoBrain Test Suite (Anthropic SDK)")
    print("  Using z.ai with GLM Models")
    print("=" * 60)
